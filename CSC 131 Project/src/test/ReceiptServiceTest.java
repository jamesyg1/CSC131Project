...
class ReceiptServiceTest {
    ...
    void testNullReceipt() {
        ...
        list.createReceipt(user, new ArrayList<Item>(), "Test", "5/4/2026");
    ...
    void testReceiptListCreation() {
        ...
        list.createReceipt(user, new ArrayList<Item>(), "Test1", "5/4/2026");
        list.createReceipt(user, new ArrayList<Item>(), "Test2", "5/5/2026");
    ...
    void testAddItemToReceiptInListAndSum() {
        ...
        list.addItemToReceipt(list.createReceipt(user, new ArrayList<Item>(), "Test1", "5/4/2026"), new Item("Pen", 2, 1.5));
        ...
        assertEquals(8.0, list.getReceiptTotal(list.getAllReceipts().get(0)));
    }
    ...
    void testRemoveItemFromReceiptInListAndSum() {
        ...
        list.addItemToReceipt(list.createReceipt(user, new ArrayList<Item>(), "Food", "5/4/2026"), new Item("Hotdog", 3, 3.99));
        list.addItemToReceipt(list.createReceipt(user, new ArrayList<Item>(), "School Supplies", "5/4/2026"), new Item("Pen", 2, 1.5));
        ...
        assertEquals(5.0, list.getReceiptTotal(list.getAllReceipts().get(1)));
    }

    @Test
    void testGetReceiptTotal() {
        User user = new User(1, "test@email.com", "pass123", "John");
        ReceiptService list = new ReceiptService();

        Receipt receipt = list.createReceipt(user, new ArrayList<Item>(), "Test", "5/4/2026");
        list.addItemToReceipt(receipt, new Item("Pen", 2, 1.5));
        list.addItemToReceipt(receipt, new Item("Notebook", 1, 5.0));

        assertEquals(8.0, list.getReceiptTotal(receipt));
    }
}